      ...
      <div>
        ...
        <div className="grid grid-cols-4 gap-5 mt-9">
          ...
          {/* <div>
            ...
            <div className="text-gray-500">
              This is description of benefit 1.
            </div>
          </div>
          <div>
            <PartyPopperIcon className="w-10 h-10 text-primary mb-6" />

            <div className="text-lg font-semibold mb-3">Benefit 2</div>
            <div className="text-gray-500">
              This is description of benefit 2.
            </div>
          </div>
          <div>
            <PartyPopperIcon className="w-10 h-10 text-primary mb-6" />

            <div className="text-lg font-semibold mb-3">Benefit 3</div>
            <div className="text-gray-500">
