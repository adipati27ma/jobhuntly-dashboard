...
const PostAJobPage: FC<PostAJobPageProps> = (props: PostAJobPageProps) => {
  ...
  let { data: jobCategories } = useSWR<CategoryJob[]>(
    '/api/job/categories',
    fetcher
  );
  ...
  async function onSubmit(values: z.infer<typeof jobFormSchema>) {
    ...
    try {
      /**
       *!tbd: Job type error because no "id" found (required),
       * "id" auto-generated by Prisma/Railway
       */
      // const body: Job = {
      const body: any = {
        applicants: 0,
        ...
        companyId: session?.user.id as string,
